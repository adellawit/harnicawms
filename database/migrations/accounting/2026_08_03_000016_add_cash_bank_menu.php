...
return new class extends Migration
{
    ...
    private const MENU_ID = 'a1c00001-f001-4001-8001-000000000009';
    ...
    public function up(): void
    {
        ...
        $exists = DB::table('master_data.menus')
            ->where(function ($q) {
                $q->where('id', self::MENU_ID)->orWhere('code', 'cash_bank');
            })
            ->exists();
        ...
        if (! $exists && DB::table('master_data.menus')->where('id', self::FINANCE_PARENT_ID)->exists()) {
            DB::table('master_data.menus')->insert([
                ...
                'name' => 'Cash & Bank',
                'code' => 'cash_bank',
                'text_sidebar' => 'Cash & Bank',
                'icon' => 'ti ti-building-bank',
                'has_page' => false,
                'url_path' => 'finance/cash-bank',
                'route_name' => 'finance.cash-bank.index.view',
                'slug' => 'cash-bank',
                'level_sidebar' => 2,
                'order_number' => 8,
                'is_label' => false,
