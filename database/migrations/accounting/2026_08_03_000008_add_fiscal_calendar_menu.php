...
return new class extends Migration
{
    ...
    private const MENU_ID = 'a1c00001-f001-4001-8001-000000000005';
    ...
    public function up(): void
    {
        ...
        if (! $exists && DB::table('master_data.menus')->where('id', self::FINANCE_PARENT_ID)->exists()) {
            DB::table('master_data.menus')->insert([
                ...
                'text_sidebar' => 'Fiscal Calendar',
                'icon' => 'ti ti-calendar-stats',
                'has_page' => false,
                'url_path' => 'finance/fiscal-calendar',
                'route_name' => 'finance.fiscal-calendar.index.view',
