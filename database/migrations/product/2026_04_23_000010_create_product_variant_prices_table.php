...
{
    /**
     * Product variant prices - per variant, branch & unit
     * Variant prices override base product prices
     */
    public function up(): void
    {
        Schema::create('product.product_variant_prices', function (Blueprint $table) {
            $table->uuid('id')
                ->primary()
            ...
            $table->unique(['variant_id', 'branch_id', 'unit_id']);
    ...
    {
        Schema::dropIfExists('product.product_variant_prices');
    }
};
