...
class AgentCuttingPriceAccessSeeder extends Seeder
{
    ...
    private const REPORT_MENU_ID = 'e2345678-0042-cdef-0123-456789abcdef';

    private const SALES_PARENT_ID = 'e2345678-0031-cdef-0123-456789abcdef';
    ...
    public function run(): void
    {
        $reportMenu = Menu::withTrashed()->updateOrCreate(
            ...
            [
                'parent_id' => self::SALES_PARENT_ID,
                'name' => 'Agent Cutting Price',
                'code' => 'reporting_agent_cutting_price',
                'text_sidebar' => 'Agent Cutting Price',
                'icon' => 'ti ti-discount-2',
                'has_page' => false,
                'url_path' => 'reporting/agent-cutting-price',
                'route_name' => 'reporting.agent-cutting-price.index',
                'slug' => 'reporting-agent-cutting-price',
                'level_sidebar' => 3,
                'order_number' => 11,
                'is_label' => false,
                'has_create' => false,
        ...
        foreach ([
            ...
            self::SALES_PARENT_ID => ['is_read' => true],
