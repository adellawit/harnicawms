@if(config('agent.enabled') && auth()->check() && \App\Support\AgentChatAccess::canShowWidget(auth()->user()))
        <link rel="stylesheet" href="{{ asset('assets/css/agent-chat.css') }}">
        ...
        <script src="{{ asset('assets/js/agent-chat.js') }}"></script>
@endif
