        ...
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm shop-checkout-card shop-checkout-payment-card">
                ...
                <div class="card-body pt-0 pb-3 pb-lg-4">
                    <form method="POST" action="{{ route('customer.checkout.process') }}" id="checkoutForm">
                        @csrf
                        <div class="mb-3">
            ...
            <a href="{{ route('customer.shop') }}" class="btn btn-link btn-sm mt-2 ps-0 shop-checkout-back">
                <i class="ti ti-arrow-left"></i> Kembali belanja
            </a>
        </div>
    </div>
