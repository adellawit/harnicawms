<x-app-layout>
    @section('title', 'Tambah Cutting Price Config | ')
    @push('vendor-css')
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="padding-bottom: 70px !important;">
        ...
        <div class="card">
            <h5 class="card-header fw-bold">Tambah Cutting Price Config</h5>
            <form method="POST" action="{{ route('partner.cutting-price-config.insert.data') }}" id="postForm">
                @csrf
                <hr style="margin: 0.5rem 0;" />
                <div class="card-body">
                    @include('admin.partner.cutting-price-config._form')
                </div>
