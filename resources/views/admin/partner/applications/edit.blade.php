<x-app-layout>
    @section('title', 'Ubah Pendaftaran Partner | ')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <x-page-header :breadcrumbs="[
            ...
            ['label' => $application->application_number, 'url' => route('partner.applications.show', $application->id)],
            ['label' => 'Ubah', 'active' => true],
        ]" />

        <form method="POST" action="{{ route('partner.applications.update', $application) }}" enctype="multipart/form-data" id="partnerApplicationForm">
            @csrf
            @method('PUT')
                ...
                <div class="pr-shell">
                    <div class="pr-card">
                        <div class="pr-hero pr-reveal pr-reveal--instant">
                            ...
                            <p class="pr-hero__lead">Perbarui data pendaftaran {{ $application->application_number }}.</p>
                        </div>
            ...
            <div class="d-flex flex-wrap gap-2 mt-3">
                <button type="submit" class="btn btn-primary me-2" id="partnerSubmitBtn">
                    Submit
                </button>
                <a href="{{ route('partner.applications.show', $application->id) }}" class="btn btn-outline-secondary">Batal</a>
            </div>
        </form>
    </div>
