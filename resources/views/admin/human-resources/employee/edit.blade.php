        ...
        <div class="row mb-3">
            ...
            <div class="col-md mb-4 mb-md-2">
                <div class="card accordion mt-3" id="accordionWithIcon">
                    <h5 class="card-header fw-bold" style="color: #212529">Edit Employee</h5>
                    <form method="POST" enctype="multipart/form-data" action="{{ route('users.edit.data') }}"
                        id="postForm">
                        @csrf
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="employee_code" name="employee_code" class="form-control"
                                                placeholder="EMP-001" value="{{ old('employee_code', $employee->employee_code) }}" />
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="identity_number" name="identity_number" class="form-control"
                                                placeholder="320xxxxxxxxxxxxxx" value="{{ old('identity_number', $employee->identity_number) }}" />
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label" for="fullname">Nama Lengkap<span style="color: red">*</span></label>
                                            <input type="text" id="fullname" name="fullname" class="form-control"
                                                placeholder="Enter Full Name" value="{{ old('fullname', $employee->fullname) }}" />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label" for="nickname">Nama Panggilan</label>
                                            <input type="text" id="nickname" name="nickname" class="form-control"
                                                placeholder="Enter Nickname" value="{{ old('nickname', $employee->nickname) }}" />
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" id="number_of_dependents" name="number_of_dependents" class="form-control"
                                                placeholder="0" value="{{ old('number_of_dependents', $employee->number_of_dependents ?? 0) }}" min="0" />
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="place_of_birth" name="place_of_birth" class="form-control"
                                                placeholder="Enter Place of Birth" value="{{ old('place_of_birth', $employee->place_of_birth) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label" for="date_of_birth">Tanggal Lahir</label>
                                            <input type="text" id="date_of_birth" name="date_of_birth"
                                                class="form-control dob-picker" placeholder="DD MMMM YYYY" value="{{ old('date_of_birth', $employee->date_of_birth) }}" />
                                        </div>
                                        <div class="col-md-4">
                            ...
                            <div id="accordionContact" class="accordion-collapse collapse">
                                <div class="accordion-body">
                                    <div class="row g-3 mb-4">
                                        ...
                                        @php
                                            $selectedProvince = old('province', $employee->province ?? '');
                                            $selectedCity = old('city', $employee->city ?? '');
                                        @endphp
                                        <div class="col-md-6">
                                            <label class="form-label">Provinsi</label>
                                            <input type="hidden" name="province" id="province_name_hidden" value="{{ old('province', $employee->province ?? '') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="city" id="city_name_hidden" value="{{ old('city', $employee->city ?? '') }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="postal_code" name="postal_code" class="form-control"
                                                placeholder="12345" value="{{ old('postal_code', $employee->postal_code) }}" />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label" for="phone_number">Nomor Telepon</label>
                                            <input type="text" id="phone_number" name="phone_number" class="form-control"
                                                placeholder="08xxxxxxxxxx" value="{{ old('phone_number', $employee->phone_number) }}"
                                    ...
                                    <div class="row g-3 mb-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="division_id" name="division_id" class="select2 form-select" data-allow-clear="true">
                                                ...
                                                @foreach($divisions as $division)
                                                    <option value="{{ $division->id }}" @if ($division->id == $employee->division_id) selected @endif>
                                                        {{ $division->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="join_date" name="join_date"
                                                class="form-control date-picker" placeholder="DD MMMM YYYY" value="{{ old('join_date', $employee->join_date) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="contract_start_date" name="contract_start_date"
                                                class="form-control date-picker" placeholder="DD MMMM YYYY" value="{{ old('contract_start_date', $employee->contract_start_date) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="contract_end_date" name="contract_end_date"
                                                class="form-control date-picker" placeholder="DD MMMM YYYY" value="{{ old('contract_end_date', $employee->contract_end_date) }}" />
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select id="employment_status" name="employment_status" class="select2 form-select" data-allow-clear="true">
                                                ...
                                                <option value="Intern" @if (old('employment_status', $employee->employment_status) == 'Intern') selected @endif>Intern</option>
                                                <option value="Freelance" @if (old('employment_status', $employee->employment_status) == 'Freelance') selected @endif>Freelance</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select id="employee_status" name="employee_status" class="select2 form-select" data-allow-clear="true">
                                                <option value="">Select</option>
                                                <option value="Active" @if (old('employee_status', $employee->employee_status) == 'Active') selected @endif>Active</option>
                                                <option value="Inactive" @if (old('employee_status', $employee->employee_status) == 'Inactive') selected @endif>Inactive</option>
                                                <option value="Resigned" @if (old('employee_status', $employee->employee_status) == 'Resigned') selected @endif>Resigned</option>
                                                <option value="Terminated" @if (old('employee_status', $employee->employee_status) == 'Terminated') selected @endif>Terminated</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="tax_number" name="tax_number" class="form-control"
                                                placeholder="xx.xxx.xxx.x-xxx.xxx" value="{{ old('tax_number', $employee->tax_number) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="bpjs_kesehatan" name="bpjs_kesehatan" class="form-control"
                                                placeholder="xxxxxxxxxx" value="{{ old('bpjs_kesehatan', $employee->bpjs_kesehatan) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="bpjs_ketenagakerjaan" name="bpjs_ketenagakerjaan" class="form-control"
                                                placeholder="xxxxxxxxxx" value="{{ old('bpjs_ketenagakerjaan', $employee->bpjs_ketenagakerjaan) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label" for="bank_name">Nama Bank</label>
                                            <input type="text" id="bank_name" name="bank_name" class="form-control"
                                                placeholder="BCA, Mandiri, etc." value="{{ old('bank_name', $employee->bank_name) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="bank_account_number" name="bank_account_number" class="form-control"
                                                placeholder="xxxxxxxxxx" value="{{ old('bank_account_number', $employee->bank_account_number) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="bank_account_name" name="bank_account_name" class="form-control"
                                                placeholder="Account Holder Name" value="{{ old('bank_account_name', $employee->bank_account_name) }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="emergency_contact_name" name="emergency_contact_name" class="form-control"
                                                placeholder="Emergency Contact Name" value="{{ old('emergency_contact_name', $employee->emergency_contact_name) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="emergency_contact_relation" name="emergency_contact_relation" class="form-control"
                                                placeholder="Spouse, Parent, Sibling, etc." value="{{ old('emergency_contact_relation', $employee->emergency_contact_relation) }}" />
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="emergency_contact_phone" name="emergency_contact_phone" class="form-control"
                                                placeholder="08xxxxxxxxxx" value="{{ old('emergency_contact_phone', $employee->emergency_contact_phone) }}"
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="role_id" name="role_id" class="select2 form-select" data-allow-clear="true">
                                                ...
                                                <option value="{{ $emp->id }}" @if ($emp->id == $user->role_id) selected @endif>
                                                    {{ $emp->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                        ...
                                        @php
                                            $isSuperAdmin = auth()->user() && auth()->user()->role_id === '147c8a8e-52dc-4a79-a8ce-acb612b6e484';
                                        @endphp
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-password-toggle">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <span class="input-group-text cursor-pointer" id="password_confirmation2">
                                                            <i class="ti ti-eye-off"></i>
                                                        </span>
                                                    </div>
                                                </div>
            ...
            $(document).ready(function() {
                ...
                $('#province_select').on('select2:select', function(e) {
                    ...
                    $.get('/helper/cities', { province_id: provinceId, per_page: 9999 }, function(data) {
                        ...
                        const oldCity = '{{ old('city', $employee->city ?? '') }}';
                ...
                @if($selectedProvinceId && $employee->province)
                    // Pre-select the province in Select2 using data object
                    var provinceOption = new Option('{{ $employee->province }}', '{{ $selectedProvinceId }}', true, true);
                    $('#province_select').append(provinceOption).trigger('change');
                    $('#province_name_hidden').val('{{ $employee->province }}');
                    ...
                    $.get('/helper/cities', { province_id: '{{ $selectedProvinceId }}', per_page: 9999 }, function(data) {
                        ...
                        @if($employee->city)
                            $citySelect.val('{{ $employee->city }}').trigger('change');
                            $('#city_name_hidden').val('{{ $employee->city }}');
                        @endif
                    });
                @endif
                ...
                // Initial load with explicit chaining
                var initHolding = '{{ $selectedHoldingId ?? '' }}';
                var initCompany = '{{ $selectedCompanyId ?? '' }}';
                var initBranch = '{{ $selectedBranchId ?? '' }}';

                loadBusinessUnits('HOLDING', null, $('#holding_id'), initHolding, function() {
                    if (initHolding) {
                        loadBusinessUnits('COMPANY', initHolding, $('#company_id'), initCompany, function() {
                            if (initCompany) {
                                loadBusinessUnits('BRANCH', initCompany, $('#current_business_unit_id'), initBranch, function() {
                                    isInitialLoad = false;
                                });
                            } else {
                                isInitialLoad = false;
