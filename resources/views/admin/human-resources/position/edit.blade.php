<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="padding-bottom: 70px !important;">
        ...
        <x-page-header
            :breadcrumbs="[
                ...
                ['label' => 'Position', 'url' => route('position.index.view')],
        ...
        <div class="row mb-3">
            ...
            <div class="col-md mb-4 mb-md-2">
                <div class="card accordion mt-3" id="accordionWithIcon">
                    <h5 class="card-header fw-bold" style="color: #212529">Edit Position</h5>
                    <form method="POST" enctype="multipart/form-data" action="{{ route('position.edit.data') }}"
                        id="postForm">
                        @csrf
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12 d-none">
                                        ...
                                        <input type="text" id="id" name="id" class="form-control"
                                            placeholder="Input ID" value="{{ $position['id'] }}" readonly />
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label" for="name">Position<span
                                                style="color: red">*</span></label>
    ...
    <div class="floating-footer d-flex justify-content-end align-items-center">
        <div>
            <a href="{{ route('position.index.view') }}" type="button" class="btn btn-outline-dark me-2"><span
