        ...
        <div class="row mb-3">
            ...
            <div class="col-md mb-4 mb-md-2">
                <div class="card accordion mt-3" id="accordionWithIcon">
                    <h5 class="card-header fw-bold" style="color: #212529">Edit Division</h5>
                    <form method="POST" enctype="multipart/form-data" action="{{ route('division.edit.data') }}"
                        id="postForm">
                        @csrf
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12 d-none">
                                        ...
                                        <input type="text" id="id" name="id" class="form-control"
                                            placeholder="Input ID" value="{{ $division['id'] }}" readonly />
                                    </div>
                                    <div class="col-md-12">
