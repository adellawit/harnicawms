    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                <div>
                    ...
                    @else
                        <small class="text-muted">Menampilkan stok agregat semua gudang — pilih gudang spesifik di Filter sebelum Save Adjustment</small>
                    @endif
                </div>
        ...
        <x-modal id="filterModal" title="Filter">
            <div class="mb-3">
                ...
                <small class="text-muted">Default: semua gudang. Pilih satu gudang sebelum Save Adjustment.</small>
            </div>
            <div class="mb-3">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.btn-save').on('click', function() {
                    ...
                    if (!warehouseId) {
                        showAlert('warning', 'Pilih satu gudang di Filter sebelum Save Adjustment (tidak bisa simpan di mode Semua Gudang).');
                        return;
                    }
