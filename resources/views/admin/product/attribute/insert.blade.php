<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="padding-bottom: 70px !important;">
        ...
        <div class="card">
            <h5 class="card-header fw-bold">Add Attribute Definition</h5>
            <form method="POST" action="{{ route('product.attribute.insert.data') }}" id="postForm">
                @csrf
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="name" name="name" class="form-control" placeholder="e.g. Color" value="{{ old('name') }}" required />
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="code">Code <span class="text-danger">*</span></label>
                            <input type="text" id="code" name="code" class="form-control" placeholder="e.g. color" value="{{ old('code') }}" required />
                        </div>
                        <div class="col-md-6">
    ...
    <div class="floating-footer d-flex justify-content-end align-items-center">
        <a href="{{ route('product.attribute.index.view') }}" class="btn btn-outline-dark me-2">Cancel</a>
