<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="padding-bottom: 70px !important;">
        ...
        <div class="card">
            <h5 class="card-header fw-bold">Add Price List</h5>
            <form method="POST" action="{{ route('product.price-list.insert.data') }}" id="postForm">
                @csrf
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="code" name="code" class="form-control" placeholder="e.g., NORMAL" value="{{ old('code') }}" required />
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="name">Name <span class="text-danger">*</span></label>
                            <input type="text" id="name" name="name" class="form-control" placeholder="e.g., Harga Normal" value="{{ old('name') }}" required />
                        </div>
                        <div class="col-md-6">
                            ...
                            <select id="channel_type" name="channel_type" class="select2 form-select">
                                ...
                                <option value="pos" {{ old('channel_type') == 'pos' ? 'selected' : '' }}>POS / Kasir</option>
                                <option value="marketplace" {{ old('channel_type') == 'marketplace' ? 'selected' : '' }}>Marketplace</option>
                                <option value="delivery" {{ old('channel_type') == 'delivery' ? 'selected' : '' }}>Delivery / Ojol</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="external_channel_code">External Channel Code</label>
                            <input type="text" id="external_channel_code" name="external_channel_code" class="form-control" placeholder="e.g., gofood, grabfood" value="{{ old('external_channel_code') }}" />
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="description" name="description" class="form-control" rows="2" placeholder="Optional description">{{ old('description') }}</textarea>
                        </div>
                        <div class="col-12">
