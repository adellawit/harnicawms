<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="padding-bottom: 70px !important;">
        ...
        <div class="card">
            <h5 class="card-header fw-bold">Edit Tarif Ongkir</h5>
            <form method="POST" action="{{ route('shipping-rate.edit.data') }}" id="postForm">
                @csrf
                ...
                <div class="card-body">
                    <div class="row g-3">
                        @include('admin.master-data.shipping-rate._city-select', [
                            ...
                            'label' => 'Kota Asal',
                            'selectedId' => old('origin_city_id', $rate->origin_city_id),
                            'selectedText' => old('origin_city_id')
                                ? null
                                : trim(($originCity?->name ?? '').($originCity?->province?->name ? ' ('.$originCity->province->name.')' : '')),
                        ...
                        @include('admin.master-data.shipping-rate._city-select', [
                            ...
                            'label' => 'Kota Tujuan',
                            'selectedId' => old('destination_city_id', $rate->destination_city_id),
                            'selectedText' => old('destination_city_id')
                                ? null
                                : trim(($destinationCity?->name ?? '').($destinationCity?->province?->name ? ' ('.$destinationCity->province->name.')' : '')),
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="courier_code" name="courier_code" class="form-select select2" required>
                                @foreach($couriers as $code => $label)
                                    <option value="{{ $code }}" @selected(old('courier_code', $rate->courier_code) === $code)>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="service_code" name="service_code" class="form-control" value="{{ old('service_code', $rate->service_code) }}" required maxlength="30">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="service_name" name="service_name" class="form-control" value="{{ old('service_name', $rate->service_name) }}" maxlength="100">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="base_amount" name="base_amount" class="form-control number-format" inputmode="decimal" value="{{ format_number(old('base_amount', $rate->base_amount), 2, true) }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="per_kg_amount" name="per_kg_amount" class="form-control number-format" inputmode="decimal" value="{{ format_number(old('per_kg_amount', $rate->per_kg_amount), 2, true) }}" required>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" id="etd_min_days" name="etd_min_days" class="form-control" min="0" value="{{ old('etd_min_days', $rate->etd_min_days) }}">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" id="etd_max_days" name="etd_max_days" class="form-control" min="0" value="{{ old('etd_max_days', $rate->etd_max_days) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="is_active" name="is_active" value="1" @checked(old('is_active', $rate->is_active ? '1' : '0') == '1')>
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="notes" name="notes" class="form-control" rows="2">{{ old('notes', $rate->notes) }}</textarea>
