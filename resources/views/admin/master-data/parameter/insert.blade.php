        ...
        <div class="row mb-3">
            ...
            <div class="col-md mb-4 mb-md-2">
                <div class="card accordion mt-3" id="accordionWithIcon">
                    <h5 class="card-header fw-bold" style="color: #212529">Add Parameter</h5>
                    <form method="POST" enctype="multipart/form-data" action="{{ route('parameter.insert.data') }}"
                        id="postForm">
                        @csrf
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                        placeholder="Enter Parameter Name" value="{{ old('name') }}" />
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label" for="description">Description</label>
                                    <textarea id="description" name="description" class="form-control" rows="3"
                                        placeholder="Enter Parameter Description">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </form>
