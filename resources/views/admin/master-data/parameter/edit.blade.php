<x-app-layout>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md mb-4 mb-md-2">
                <div class="card accordion mt-3" id="accordionWithIcon">
                    <h5 class="card-header fw-bold" style="color: #212529">Edit Parameter</h5>
                    <form method="POST" enctype="multipart/form-data" action="{{ route('parameter.edit.data') }}"
                        id="postForm">
                        @csrf
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12 d-none">
                                        ...
                                        <input type="text" id="id" name="id" class="form-control"
                                            placeholder="Input ID" value="{{ $parameter['id'] }}" readonly />
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="description" name="description" class="form-control" rows="3"
                                            placeholder="Enter Parameter Description">{{ old('description', $parameter['description']) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="floating-footer d-flex justify-content-end align-items-center">
        <div>
                <a href="{{ route('parameter.index.view') }}" type="button" class="btn btn-outline-dark me-2"><span
