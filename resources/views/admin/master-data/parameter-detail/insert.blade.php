        ...
        <div class="row mb-3">
            ...
            <div class="col-md mb-4 mb-md-2">
                <div class="card accordion mt-3" id="accordionWithIcon">
                    <h5 class="card-header fw-bold" style="color: #212529">Add Detail for {{ $parameter->name }}</h5>
                    <form method="POST" enctype="multipart/form-data" action="{{ route('parameter.details.insert.data', $parameterId) }}"
                        id="postForm">
                        @csrf
