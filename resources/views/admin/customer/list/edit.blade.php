                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="address_ktp" name="address_ktp" class="form-control" rows="2" placeholder="Alamat sesuai KTP">{{ old('address_ktp', $customer->address_ktp) }}</textarea>
                        </div>
                        <div class="col-12">
                            <label class="form-label" for="address_shipping">Alamat Pengiriman</label>
                            <textarea id="address_shipping" name="address_shipping" class="form-control" rows="2" placeholder="Alamat domisili / pengiriman barang">{{ old('address_shipping', $customer->address_shipping ?: $customer->address) }}</textarea>
                        </div>
                        <div class="col-md-4">
