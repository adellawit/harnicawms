    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Add New Holding</h5>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('holding.insert.data') }}">
                    @csrf
                                ...
                                <div class="accordion-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="parent_id" class="select2 form-select">
                                                ...
                                                @foreach ($parentBusinessUnits as $parent)
                                                    <option value="{{ $parent->id }}">{{ $parent->type_code }} - {{ $parent->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('parent_id')
                                                <div class="text-danger small">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Enter business unit name" required>
                                            @error('name')
                                                <div class="text-danger small">{{ $message }}</div>
                                            @enderror
                                        </div>
