<x-app-layout>
    ...
    @section('title', 'Add Membership Configuration | ')
    ...
    <div class="container-xxl flex-grow-1 container-p-y" style="padding-bottom: 70px !important;">
        ...
        <div class="card accordion mt-3">
            <h5 class="card-header fw-bold" style="color: #212529">Add Membership Configuration</h5>
            <form method="POST" action="{{ route('crm.membership-configuration.insert.data') }}" id="postForm">
                @csrf
                ...
                <div class="accordion-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="name" name="name" class="form-control" placeholder="Example: Default Rule" value="{{ old('name') }}" />
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="transaction_amount_step">Transaction Amount Step<span style="color: red">*</span></label>
                            <input type="number" min="1" id="transaction_amount_step" name="transaction_amount_step" class="form-control" placeholder="100" value="{{ old('transaction_amount_step', 100) }}" />
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="points_per_step">Points per Step<span style="color: red">*</span></label>
                            <input type="number" min="1" id="points_per_step" name="points_per_step" class="form-control" placeholder="1" value="{{ old('points_per_step', 1) }}" />
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="redeem_value_per_point">Redeem Value per Point (Rp)<span style="color: red">*</span></label>
                            <input type="number" min="1" id="redeem_value_per_point" name="redeem_value_per_point" class="form-control" placeholder="100" value="{{ old('redeem_value_per_point', 100) }}" />
                            <small class="text-muted">Contoh: 1 poin = Rp 100 diskon</small>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label" for="description">Description</label>
                            <textarea id="description" name="description" class="form-control" rows="3" placeholder="Optional description">{{ old('description') }}</textarea>
                        </div>
                        <div class="col-md-12">
